...
unsigned int pulse_width3=600;//calculate pulse width;//calculate pulse width;//pulse width
...
//	GPIO_init(Rotation, INPUT);  //led pin
	...
	//auto mode
//	GPIO_init(Parking_finish_pin, OUTPUT);  //led pin
//	GPIO_write(Parking_finish_pin,1);
	...
	GPIO_init(Dir_Pin_3, OUTPUT);  //led pin
	GPIO_init(Dir_Pin_4, OUTPUT);  //led pin
...
//printf("ULTRA FLAG1 %d\r\n",Ultra_flag);
	//	printf("ULTRA FLAG2 %d\r\n",Ultra_flag2);
...
//		Ultra_check_flag=GPIO_read(Ultra_pin1);
	
		/*
		switch(Ultra_check_flag){
...
//		Parking_check_flag=GPIO_read(Parking_pin);
		...
		*/
		...
		//	GPIO_write(PC_1,1);
			...
			//before rotation and forward object detected
	...
	//			printf("stop ultra 1 \r\n");
			...
			//moving backward and detected object
	...
	//				motorDIR_2=GPIO_read(Dir_Pin_2);
			...
			//before rotattion and backward object detected
		...
		//	GPIO_write(PC_1,1);
			...
			motorPWM_4=0.8;//rotation
					...
					if((_count1>23000)&&(Finish_turn_flag==0)){
					switch(motorDIR){
					case 0:
						motorPWM=motorDIR;
					motorPWM_4=motorDIR_4;
